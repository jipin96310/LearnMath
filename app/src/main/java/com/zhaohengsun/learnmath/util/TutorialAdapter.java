...
/**
 * Created by Zhaoheng Sun on 2018/4/30.
 */

public class TutorialAdapter extends ArrayAdapter<MainItem> {

    public TutorialAdapter(Context context, ArrayList<MainItem> books) {
